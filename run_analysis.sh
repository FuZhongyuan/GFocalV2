...
# 设置日志路径
JITTOR_LOG="/root/data-fs/GFocalV2/comparison_results/jittor/it912_jittor_train_full_output.log"
PYTORCH_LOG="/root/data-fs/GFocalV2/comparison_results/pytorch/it912_pytorch_train_full_output.log"
