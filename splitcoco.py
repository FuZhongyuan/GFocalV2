...
coco = COCO('./data/coco/annotations/instances_train2017.json',
            origin_img_dir='./data/coco/train2017')               # 完整的coco数据集的图片和标注的路径
coco.build('./mini_train2017', './mini_instances_train2017.json', 924)  # 保存图片路径


coco = COCO('./data/coco/annotations/instances_val2017.json',
            origin_img_dir='./data/coco/val2017')                 # 完整的coco数据集的图片和标注的路径
coco.build('./mini_val2017', './mini_instances_val2017.json', 39)       # 保存图片路径

# 在2017年数据集中,训练集118287张,验证5000张,测试集40670张.
# 118287/128 = 924 5000/128 = 39