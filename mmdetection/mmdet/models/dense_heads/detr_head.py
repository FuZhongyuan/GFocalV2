...
from ..losses import QualityFocalLoss, RTDETRVflLoss
...
class DETRHead(BaseModule):
    ...
    def loss_by_feat_single(self, cls_scores: Tensor, bbox_preds: Tensor,
        ...
        if isinstance(self.loss_cls, QualityFocalLoss) or isinstance(self.loss_cls, RTDETRVflLoss):
    ...
    def _predict_by_feat_single(self,
        ...
        results.cls_scores = cls_score[:300]
        return results
