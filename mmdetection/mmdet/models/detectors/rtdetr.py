...
from ..layers import (CdnQueryGenerator, DinoTransformerDecoder, 
                      SinePositionalEncoding, HybridEncoder)
...
class RTDETR(DeformableDETR):
    ...
    def _init_layers(self) -> None:
        ...
        self.encoder = HybridEncoder(**self.encoder)
    ...
    def forward_encoder(self, feat: Tensor, feat_mask: Tensor,
        ...
        (memory, _, _) = self._get_encoder_input(feats)
