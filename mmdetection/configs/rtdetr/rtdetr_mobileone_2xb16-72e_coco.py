...
checkpoint = '/root/andrewhoux/mgh/mmdetection/work_dirs/mobileone-s0_8xb32_in1k_20221110-0bc94952.pth'
...
model = dict(
    ...
    decoder=dict(
        ...
        layer_cfg=dict(
            self_attn_cfg=dict(embed_dims=96, num_heads=8,
                               dropout=0.0),  # 0.1 for DeformDETR
            cross_attn_cfg=dict(embed_dims=96, num_levels=3,
                                dropout=0.0),  # 0.1 for DeformDETR
            ffn_cfg=dict(
                embed_dims=96,
                feedforward_channels=768,  # 1024 for DeformDETR
