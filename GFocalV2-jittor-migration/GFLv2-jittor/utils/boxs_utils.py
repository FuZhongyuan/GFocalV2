...
#         r = wh[:, None] / k[None]
#         # [samples,n,2]
#         x = jt.minimum(r, 1. / r).min(2)[0]  # ratio metric
#         # x = wh_iou(wh, jt.Var(k))  # iou metric
#         # [samples,n]
#         return x, x.max(1)[0]  # x, best_x
#
#     def fitness(k):  # mutation fitness
#         _, best = metric(jt.Var(k, dtype=jt.float32), wh)
...
#     k *= s
#     wh = jt.Var(wh, dtype=jt.float32)  # filtered
#     wh0 = jt.Var(wh0, dtype=jt.float32)  # unflitered
#     k = print_results(k)
#
#     # Plot
#     # k, d = [None] * 20, [None] * 20
