...
from .commons import BoxSimilarity, IOULoss
...
class Project(jt.nn.Module):
    def __init__(self, reg_max=16):
        super(Project, self).__init__()
        self.reg_max = reg_max
        self.register_buffer("project", jt.linspace(0, self.reg_max, self.reg_max + 1))
    ...
    def execute(self, x):
        ...
        x = jt.matmul(x, self.project).view(b, n, -1)
        return x
...
class DFL(object):
    def __init__(self):
        ...
        self.ce = jt.nn.CrossEntropyLoss(reduction='none')
